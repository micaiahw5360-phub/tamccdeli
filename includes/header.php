...
<head>
    ...
    <script>
        window.kioskMode = <?php echo json_encode($kiosk_mode); ?>;
    </script>
</head>
<body class="<?php echo $kiosk_mode ? 'kiosk-mode' : ''; ?>">
<?php if (!$hide_header): ?>
    <nav class="navbar">
        <div class="container flex items-center justify-between">
            <a href="<?= kiosk_url('/index.php') ?>" class="logo flex items-center gap-2">
                <img src="/assets/images/ta-logo-1536x512.png" alt="TAMCC Deli" style="height: 40px;">
                <span class="font-bold text-primary">TAMCC Deli</span>
            </a>
            ...
            <div class="nav-links">
                ...
                <?php if (isset($_SESSION['user_id']) && ($_SESSION['role'] === 'admin' || $_SESSION['role'] === 'staff') && !$kiosk_mode): ?>
                    <a href="?kiosk=1" class="btn-sm" style="background: #ff66c4; color: white;">🎮 Enter Kiosk Mode</a>
                <?php endif; ?>
